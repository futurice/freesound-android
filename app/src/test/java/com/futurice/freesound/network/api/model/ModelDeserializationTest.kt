...
fun GsonBuilder.freesoundbuilder(): GsonBuilder {
    return GsonBuilder().setDateFormat(ApiConstants.DATE_FORMAT_PATTERN)
...
class ModelDeserializationTest {
    ...
    @Before
    fun setUp() {
        gson = GsonBuilder().freesoundbuilder().create()
    }
    ...
    private val expectedSoundSearchResult = SoundSearchResult(
            157008,
            "http://freesound.org/apiv2/search/text/?&query=sound&page=2&fields=geotag,images,description,username,id,url,name,duration,previews,tags,created",
            listOf(Sound.builder()
                    .id(360940)
                    ...
                    Sound.builder()
                            ...
                            .geotag(GeoLocation(4.65241157574, -74.0594869852))
                            ...
                            .images(Sound.Image.builder()
                                    ...
                                    .build())
                            .build()),
            "http://freesound.org/apiv2/search/text/?&query=sound&page=0&fields=geotag,images,description,username,id,url,name,duration,previews,tags,created")
}