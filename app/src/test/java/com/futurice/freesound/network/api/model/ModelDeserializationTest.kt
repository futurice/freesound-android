...
class ModelDeserializationTest {
    ...
    fun deserialize_sound_search_result() {
        val json = readTestDataFile("/sound_search_result.json")
        val result = gson.fromJson(json, SoundSearchResult::class.java)

        val searchResult = SoundSearchResult.builder()
                .count(157008)
