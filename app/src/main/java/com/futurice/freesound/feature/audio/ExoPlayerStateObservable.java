...
class ExoPlayerStateObservable extends Observable<PlayerState> {
    ...
    private static class Listener extends BaseExoPlayerEventListener<PlayerState> {

        Listener(ExoPlayer exoPlayer,
                 Observer<? super PlayerState> observer) {
