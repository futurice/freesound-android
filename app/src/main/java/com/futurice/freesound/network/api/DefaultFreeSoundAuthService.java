...
public class DefaultFreeSoundAuthService implements FreeSoundAuthService {

    @NonNull
    private final FreeSoundApi freeSoundApi;

    public DefaultFreeSoundAuthService(@NonNull final FreeSoundApi freeSoundApi) {
    ...
    public Single<AccessToken> getAccessToken(@NonNull final String code) {
      //  return freeSoundApi.accessToken(.);
        return null;
    }
}
